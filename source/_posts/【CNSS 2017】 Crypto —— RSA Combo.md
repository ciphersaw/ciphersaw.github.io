...
本次 [UESTC CNSS Recruit 2017](https://ctf.cnssuestc.org/) 中，Crypto 方面的题推出了RSA套餐，涉及 RSA 加密基本原理与特定情况下对 RSA 的密码攻击，对密码学初学者是个很好的练习机会，在此感谢出题人 [JHSN](http://blog.chrstm.com/) 和 [xris](http://xr1s.me/) 。
